...
<img alt="Article page" src="https://github.com/user-attachments/assets/151b7aa9-882b-47bc-bb7b-ae6b6fb839be" />

- Click on the topic to view all articles related to that topic.
  <img alt="Article topic" src="https://github.com/user-attachments/assets/ca113f9e-93b9-400b-a2c5-929728213269" />
  
---

### Article Votes

Users can view the total number of votes, upvote or downvote an article, and remove their vote.  
Voting updates are applied instantly with **optimistic rendering**, **real-time feedback**, and **clear error handling**.
...
<p float="left">
  <img width="48%" alt="Top of home page on mobile" src="https://github.com/user-attachments/assets/b39dd994-0166-413b-9caf-5c8e8420f461" />
  <img width="48%" alt="Bottom of home page on mobile" src="https://github.com/user-attachments/assets/b22eab8e-ca19-46d5-8a0d-87592a2e2950" />
</p>

<p float="left">
  <img width="32%" alt="Articles page select topic on mobile" src="https://github.com/user-attachments/assets/74d0890c-1471-4cd4-b909-ccfb57d99db3" />
  <img width="32%" alt="Sort articles on mobile" src="https://github.com/user-attachments/assets/ae1e530d-c6d4-4beb-9c34-99884e6547df" />
  <img width="32%" alt="Sort articles in dark mode on mobile" src="https://github.com/user-attachments/assets/b9c000a7-7bb5-4145-8bb1-07e3269690e1" />
</p>

<p float="left">
  <img width="48%" alt="Post comment on mobile" src="https://github.com/user-attachments/assets/bd58dbc9-2d3b-4b10-b7b1-f7fbfbc3d05c" />
  <img width="48%" alt="Comments list on mobile" src="https://github.com/user-attachments/assets/e94129aa-89b9-45f0-969d-e81c29fc39e6" />
</p>

<p float="left">
  <img width="48%" alt="Users list on mobile" src="https://github.com/user-attachments/assets/081161d4-5936-483e-8ff9-aeaafa1b9960" />
  <img width="48%" alt="Share article on mobile" src="https://github.com/user-attachments/assets/6a426fff-f236-490a-9669-fe69bd211fa2" />
</p>
